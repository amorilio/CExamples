...
bool StringAlgoritms::Palindrome()
{
	...
	for(int i=1;palindrome!=0;i++){
		// NUM will hold last digit of the number palindrome
		num=palindrome%10;
		// palindrome will hold every digits except last one.
		palindrome=palindrome/10;
		// reverse will hold previous digit * 10 and last removed palindrome digit
...
void StringAlgoritms::permute(char *a, int i, int n) 
{
	int j; 
	if (i == n)
		printf("%s\n", a);
